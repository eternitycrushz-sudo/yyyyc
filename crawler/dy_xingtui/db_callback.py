...
_CID_MAP = {
    ...
    # 补充缺失的分类映射
    '20085': '美妆个护',   # 美容仪器/个护电器
    '20007': '数码家电',   # 手机数码
    '20012': '食品饮料',   # 酒水
    '20074': '家居日用',   # 家装/家纺
    '20044': '数码家电',   # 厨房电器(油烟机/灶具等)
    '20009': '运动户外',   # 运动服饰
    '20059': '家居日用',   # 图书教育
    '20065': '数码家电',   # 净水/饮水设备
    '20027': '服饰鞋包',   # 女装
...
# 注意：迭代顺序即优先级，运动户外需在服饰鞋包前，避免冲锋衣/速干衣被误判为服饰
_KW_MAP = {
    ...
    '运动户外': [
        # 活动场景
        '露营', '野餐', '徒步', '登山', '滑雪', '骑行', '溯溪', '攀岩', '漂流', '潜水',
        '飞盘', '越野跑', '慢跑', '桨板', '陆冲', '城市露营', '精致露营',
        # 产品类目（复合词优先）
        '冲锋衣', '速干衣', '速干裤', '登山包', '登山杖', '帐篷', '睡袋', '户外电源',
        '功能鞋靴', '冲锋裤', '皮肤衣', '防晒衣',
        # 功能特性
        '速干', '防风', '防水面料', '轻量化', '三层压胶', '耐磨',
        # 运动健身
        '运动', '健身', '瑜伽', '跑步', '户外', '钓鱼', '球',
        # 器材装备
        '瑜伽垫', '跳绳', '哑铃', '瑜伽块', '拉力带', '健身球', '健身环',
        '钓鱼竿', '自行车', '滑冰鞋', '溜冰', '轮滑', '滑板', '冲浪', '划桨',
        '足球', '篮球', '排球', '乒乓球', '羽毛球', '网球',
        '跑步机', '椭圆机', '划船机', '动感单车',
        # 品牌关键词
        '始祖鸟', '巴塔哥尼亚', '北面', '萨洛蒙', 'Hoka',
        # 风格标签
        '山系', '机能风', 'Gorpcore', '都市机能',
    ],
